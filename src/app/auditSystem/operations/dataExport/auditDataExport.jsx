...
const DataExport = (props) => {
  ...
  const appliedFilters = filterStringGeneratorDynamic(auditFilters);
  ...
  useEffect(() => {
    if ((userInfo && userInfo.data) && (auditsCount && auditsCount.length)) {
      const offsetValue = 0;
      ...
      dispatch(getAuditExport(companies, appModels.SYSTEMAUDIT, auditsCount.length, offsetValue, AuditSystemModule.auditAPiFields, customFiltersQuery, rows, sortedValue.sortBy, sortedValue.sortField));
    }
  }, [userInfo, auditsCount, auditFilters]);
    ...
    <Row>
      <Col md="12" sm="12" lg="6">
        <div className="p-3 text-center">
          ...
          <Button
            ...
            color="dark"
            className="bg-zodiac"
            disabled={loading && auditsCount && auditsCount.length <= 0}
            onClick={() => {
              setExportType('pdf');
            }}
          >
      ...
      <Col md="12" sm="12" lg="12" className="d-none">
        <div id="print_report">
          ...
          <table align="center">
            <tbody>
              <tr><td style={{ textAlign: 'center' }} colSpan={5}><b>Audits Report</b></td></tr>
              <tr>
                <td>Company</td>
          ...
          {exportType === 'excel' && (
            <DataTable
              columns={auditsInfo && auditsInfo.data && auditsInfo.data.length ? dataFields : []}
              data={auditsExport && auditsExport.data ? auditsExport.data : []}
              propertyAsKey="id"
            />
          )}
        </div>
