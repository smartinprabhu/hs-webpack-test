...
const OpportunityDetailInfo = (props) => {
                  ...
                  <Row className="m-0">
                    <Col sm="12" md="9" lg="9" xs="12" className="">
                      ...
                      <span className="font-weight-500 font-tiny">
                        {getDefaultNoValue(extractNameObject(viewData.user_id, 'name'))}
                      </span>
                      <br />
                      <span className="font-weight-500 font-tiny">
                        {getDefaultNoValue(getCompanyTimezoneDate(viewData.date_deadline, userInfo, 'datetime'))}
                      </span>
                    </Col>
                ...
                <CardBody className="p-2">
                  <Row className="m-0">
                    <Col sm="12" md="9" lg="9" xs="12" className="">
                      ...
                      <p className="mb-0 font-weight-700">
                        {getDefaultNoValue(viewData.type_action)}
                      </p>
                    </Col>
                    <Col sm="12" md="3" lg="3" xs="12" className="">
                      <img src={assetDefault} alt="asset" width="20" className="mt-3" />
                    </Col>
                  </Row>
                </CardBody>
              </Card>
                ...
                <CardBody className="p-2">
                  <Row className="m-0">
                    <Col sm="12" md="9" lg="9" xs="12" className="">
                      ...
                      <p className="mb-0 font-weight-700">
                        {getDefaultNoValue(extractNameObject(viewData.stage_id, 'name'))}
                      </p>
                    </Col>
                    <Col sm="12" md="3" lg="3" xs="12" className="">
...
OpportunityDetailInfo.propTypes = {
...
export default OpportunityDetailInfo;
