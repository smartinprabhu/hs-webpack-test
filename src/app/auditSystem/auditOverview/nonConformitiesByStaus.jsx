...
const NonConformitiesByStatus = () => {
  ...
  const visitorCompany = generateArrayFromValue(auditDashboard && auditDashboard.data ? auditDashboard.data : [], 'code', 'NCS');

  return (
    <Card className="p-2 border-left-0 border-top-0 non-conformities-tabs border-bottom-0 h-100">
...
export default NonConformitiesByStatus;
