...
const ActionByStatus = () => {
  ...
  const visitorCompany = generateArrayFromValue(auditDashboard && auditDashboard.data ? auditDashboard.data : [], 'code', 'IOBS');

  return (
    <Card className="p-2 border-left-0 border-top-0 improvement-data-tab border-bottom-0 h-100">
