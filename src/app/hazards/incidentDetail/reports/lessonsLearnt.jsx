                  ...
                  <div className="p-3 mt-2">
                    ...
                    >
                      <tbody>
                        <tr>
                          <td style={tabletd}>
                            <span className="font-weight-800" style={headText}>Report On</span>
                          </td>
                          <td style={tabletd}>
                          ...
                          <td style={tabletd}>
                            <span className="font-weight-800" style={headText}>Hazard Reference</span>
                          </td>
                          <td style={tabletd}>
                      ...
                      <tbody>
                        <tr>
                          <td style={tabletdtitle}>
                            <h4 style={{ marginBottom: '0px' }}>HAZARD SUMMARY</h4>
                          </td>
                        </tr>
                        <tr>
                          <td style={tabletd}>
