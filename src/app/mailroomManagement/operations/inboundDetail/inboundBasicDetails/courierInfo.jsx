      ...
      <>
        <Row className="m-0">
          <Col sm="12" md="12" xs="12" lg="12">
            ...
            <Row className="m-0">
              <span className="m-0 p-0 font-weight-700 text-capital">{getDefaultNoValue(getCompanyTimezoneDate(detailData.collected_on, userInfo, 'datetime'))}</span>
            </Row>
            <p className="mt-2" />
            <Row className="m-0">
            ...
            <Row className="m-0">
              <span className="m-0 p-0 font-weight-700 text-capital">{getDefaultNoValue(extractNameObject(detailData.collected_by, 'name'))}</span>
            </Row>
            <p className="mt-2" />
          </Col>
        </Row>
