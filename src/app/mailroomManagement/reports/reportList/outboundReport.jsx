...
import { OutboundMailReportColumns } from '../../../commonComponents/gridColumns';
import {
      ...
      {!loading && mailRoomData && mailRoomData.length && mailRoomData.length > 0
        ? (
          ...
          <CommonGrid
            ...
            page={currentPage}
            columns={OutboundMailReportColumns()}
            limit={limit}
            checkboxSelection
            rowCount={mailRoomData.length}
            disableRowSelectionOnClick
            exportFileName="Mail Room Outbound Report"
