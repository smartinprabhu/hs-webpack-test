    ...
    <Row>
      ...
      <Modal size={(addAssetInfo && addAssetInfo.data) ? 'sm' : 'xl'} className="border-radius-50px modal-dialog-centered" isOpen={addModal}>
        ...
        <ModalBody className="pt-0 mt-0">
          <AddAsset closeModal={() => { onModalClose(1); onAssetClose(); }} afterReset={() => { onModalClose(1); onAssetClose(); }} isTheme />
        </ModalBody>
      </Modal>
      )}
      {(fieldName === 'vendor_id') && (
      <Modal size={(addVendorInfo && addVendorInfo.data) ? 'sm' : 'xl'} className="border-radius-50px modal-dialog-centered" isOpen={addModal}>
        ...
        <ModalBody className="pt-0 mt-0">
          <AddVendor closeModal={() => { onModalClose(1); onVendorClose(); }} afterReset={() => { onModalClose(1); onVendorClose(); }} isTheme />
        </ModalBody>
      </Modal>
      )}
    </Row>
