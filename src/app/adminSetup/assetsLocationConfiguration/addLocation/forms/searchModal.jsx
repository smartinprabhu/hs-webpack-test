...
const SearchModal = (props) => {
  ...
  useEffect(() => {
    if (modelName && fields) {
      ...
      if (fieldName !== 'user_role_id' && fieldName !== 'default_user_role_id' && fieldName !== 'company_ids') {
            ...
            <CardBody className="bg-color-white p-1 m-0">
              <Row className="pl-2 pr-2 pb-0 pt-0">
                ...
                <Col sm="12" md="5" lg="5" xs="12" className="text-right">
                  {fieldName === 'company_ids' ? <ModalSearch
                ...
                {((listDataMultipleInfo && listDataMultipleInfo.data) || (fieldName === 'company_ids' && allowedCompanies && allowedCompanies.loading === false)) && (
                  <Table responsive>
                    <thead className="bg-gray-light">
                      <tr>
                        {fieldName === 'company_ids' && allowedCompanies && allowedCompanies.data && (<th className="w-5">
                          <div className="checkbox">
                            <Input
                              type="checkbox"
                              value="all"
                    ...
                    <tbody>
                      {(fieldName === 'company_ids' && allowedCompanies && allowedCompanies.data) ? getRowForSites(pageData) : getRow(listDataMultipleInfo && listDataMultipleInfo.data ? listDataMultipleInfo.data : [])}
