...
import FormWizard from '../../../commonComponents/ReactFormWizard/App';
import { useWizardAPI, useWizardData, useWizardState } from '../../../commonComponents/ReactFormWizard/wizard/WizardRoot.jsx';
import selectAssets from './selectAssetsForm';
import planTheSchedule from './planTheSchedule';
    ...
    <>
      <FormWizard
        ...
        steps={[
          ...
          { id: 'Step 3', component: SelectChecklist, name: 'Select Checklists' },
          { id: 'Step 4', component: Preview, name: 'Preview and Submit/Publish' },
        ]}
      />
