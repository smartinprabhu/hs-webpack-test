...
const ByVendor = React.memo(() => {
  ...
  const workData = generateArrayFromValue(gatePassDashboard && gatePassDashboard.data ? gatePassDashboard.data : [], 'code', 'RNR');
