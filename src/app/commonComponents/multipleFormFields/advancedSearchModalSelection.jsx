...
const AdvancedSearchModal = (props) => {
  ...
  useEffect(() => {
    if (modelName && fields) {
      if (fieldName !== 'parent_id' && !advanceSearchCondition) {
      ...
      if (advanceSearchCondition) {
        let searchValueMultiple = '[';
        searchValueMultiple = `${searchValueMultiple}${advanceSearchCondition}`;
        if (searchValue) {
          searchValueMultiple = `${searchValueMultiple},["name","ilike","${searchValue}"]`;
        }
        searchValueMultiple = `${searchValueMultiple}]`;
  ...
  useEffect(() => {
    if (modelName) {
      ...
      if (searchValue && !advanceSearchCondition) {
        if (fieldName !== 'category_id' && fieldName !== 'commodity_id') {
          searchValueMultiple = `${searchValueMultiple},["name","ilike","${searchValue}"]`;
        } else {
          searchValueMultiple = `${searchValueMultiple}["name","ilike","${searchValue}"]`;
...
AdvancedSearchModal.propTypes = {
  ...
  paramsSet: PropTypes.oneOfType([
    PropTypes.array,
    PropTypes.object,
    PropTypes.bool,
    PropTypes.string,
  ]).isRequired,
  advanceSearchCondition: PropTypes.oneOfType([
    PropTypes.array,
    PropTypes.object,
    PropTypes.bool,
    PropTypes.string,
