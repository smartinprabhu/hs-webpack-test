...
const ReplaceAsset = (props) => {
  ...
  return (
    <Modal size="lg" className="border-radius-50px modal-dialog-centered modal-dialog" isOpen={modal}>
      <ModalHeaderComponent title="Replace Asset" subtitle="Please follow these steps to replace the asset" fontAwesomeIcon={faRandom} closeModalWindow={toggle} response={moveAssetInfo} />
      <ModalBody>
        <Row className="mr-4">
