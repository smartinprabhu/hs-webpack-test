...
const MoveAsset = (props) => {
  ...
  return (
    <Modal size="lg" className="border-radius-50px modal-dialog-centered" isOpen={modal}>
      <ModalHeaderComponent title="Move an Asset" subtitle="Please follow these steps to move the asset" fontAwesomeIcon={faArrowsAltH} closeModalWindow={toggle} response={moveAssetInfo} />
      <ModalBody>
        <Row className="mr-4">
            ...
            {!(moveAssetInfo && moveAssetInfo.data) && (
              <div className="mt-3">
                <Cascader
                  ...
                  onChange={onChange}
                  loadData={loadData}
                  className="thin-scrollbar font-size-13"
                  changeOnSelect
                />
              </div>
            )}
      ...
      <ModalFooter className="mr-4 ml-4">
        {!(moveAssetInfo && moveAssetInfo.data) ? (
          <Button
