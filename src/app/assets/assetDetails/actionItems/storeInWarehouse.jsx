...
const StoreInWarehouse = (props) => {
  ...
  return (
    <Modal size="md" className="border-radius-50px modal-dialog-centered" isOpen={storeModal}>
      <ModalHeaderComponent fontAwesomeIcon={faStoreAlt} closeModalWindow={toggle} title="Store in Warehouse" response={stateChangeInfo} />
      <ModalBody>
