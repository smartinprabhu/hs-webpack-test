...
const Action = (props) => {
  ...
  return (
    <>
      <Modal size="lg" className="border-radius-50px modal-dialog-centered" isOpen={actionModal}>
        <ModalHeaderComponent fontAwesomeIcon={faIcons[actionText]} closeModalWindow={toggleCancel} title={actionText} response={updateEquipment} />
