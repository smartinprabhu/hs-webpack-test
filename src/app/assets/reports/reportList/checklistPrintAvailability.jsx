...
import ChecklistExport from './checklistExportAvailability';
...
const checklistPrintEmployee = (props) => {
  ...
  return (
    <>
                        ...
                        <tbody>
                          {isData[0] && isData[0].available_assets && isData[0].available_assets.length > 0 && isData[0].available_assets.map((as) => (
                            <tr key={as}>
                              ...
                              <td style={tabletd}><span className="font-weight-400">{getCompanyTimezoneDate(as.audited_on, userInfo, 'datetime')}</span></td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
      ...
      <ChecklistExport assetAvailabilityInfo={assetAvailabilityInfo} />
    </>
  );
};
