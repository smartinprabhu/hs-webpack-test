            ...
            <tbody>
              <tr>
                <td style={{ lineHeight: '15px', width: '90px' }}>
                  <QRCode value={item.sequence_asset_hierarchy} renderAs="svg" includeMargin level="H" size={sizeValue} />
                  <br />
                  <span style={{ marginLeft: '15px' }}><b style={{ fontSize: '9px' }}>{item.sequence_asset_hierarchy}</b></span>
                </td>
                <td style={{ lineHeight: '15px', textAlign: 'center' }}>
                  ...
                  <span style={{ fontSize: '9px' }}><b>{item.space_name}</b></span>
                </td>
              </tr>
            </tbody>
          </table>
