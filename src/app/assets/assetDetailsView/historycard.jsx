...
const HistoryCard = React.memo((props) => {
  ...
  const openWorkOrder = (orderId) => {
    setOrderName('');
    if (orderId) {
      dispatch(getOrderDetail(orderId, appModels.ORDER));
      setAddLink(true);
      setViewModal(true);
          ...
          <td className="p-2 w-20">
            <Tooltip title="View workorder">
              <Button
                ...
                className="hoverColor pb-05 pt-05 font-11 border-color-red-gray  text-white rounded-pill mb-1 mr-2"
