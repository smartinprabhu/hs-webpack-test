...
import { equipmentStateChange, getAssetDetail, updateLocationData, resetScrap } from '../../equipmentService';
...
const ScrapAsset = (props) => {
  ...
  return (
    <Dialog maxWidth="md" open={scrapModal}>
      <DialogHeader title="Scrap an Asset" onClose={toggle} response={stateChangeInfo} imagePath={closeCircle} />
      <DialogContent>
