...
const OperativeAsset = (props) => {
  ...
  return (
    <Dialog maxWidth="md" open={operativeModal}>
      <DialogHeader title="Operative Asset" onClose={toggle} response={operativeInfo || addLocationInfo} fontAwesomeIcon={faTools} />
      <DialogContent>
