      ...
      <Row className="mb-3 assest-request-form">
        <Col xs={12} sm={12} lg={6} md={12}>
          <Col xs={12} sm={12} lg={12} md={12}>
            <InputField name={Name.name} label={Name.label}  type="text" formGroupClassName="m-1" maxLength="100" />
          </Col>
        ...
        <Col xs={12} sm={12} lg={6} md={12}>
          <Col xs={12} sm={12} lg={12} md={12}>
            ...
            />
            {(categoriesInfo && categoriesInfo.err && categoryOpen) && (<FormHelperText><span className="text-danger">{generateErrorMessage(categoriesInfo)}</span></FormHelperText>)}
          </Col>
