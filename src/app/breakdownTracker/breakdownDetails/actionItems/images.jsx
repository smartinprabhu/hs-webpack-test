...
import { mergeArray, isMemorySizeLargeNew, getFileExtension } from '../../../util/appUtils';
      ...
      <Row className="mb-2">
        <Col md="12" lg="12">
          ...
          <span className="float-right">
            {((!uploadPhoto.length) || (uploadPhoto && parseInt(uploadPhoto.length) < parseInt(filesLimit))) && (
              <ReactFileReader
