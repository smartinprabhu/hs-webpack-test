...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'GET_CLOSURE_DURATION_INFO':
      return {
        ...state,
        closureDurationInfo: (state.closureDurationInfo, { loading: true, data: null, err: null }),
      };
    case 'GET_CLOSURE_DURATION_INFO_SUCCESS':
      return {
        ...state,
        closureDurationInfo: (state.closureDurationInfo, { loading: false, data: action.payload.data, err: null }),
      };
    case 'GET_CLOSURE_DURATION_INFO_FAILURE':
      return {
        ...state,
        closureDurationInfo: (state.closureDurationInfo, { loading: false, err: action.error, data: null }),
      };
    case 'RESET_CLOSURE_DURATION_INFO':
      return {
        ...state,
        closureDurationInfo: (state.closureDurationInfo, { loading: false, err: null, data: null }),
      };
    case 'GET_BT_OH_REQUEST_INFO':
      return {
        ...state,
        btOnHoldRequest: (state.btOnHoldRequest, { loading: true, data: null, err: null }),
      };
    case 'GET_BT_OH_REQUEST_INFO_SUCCESS':
      return {
        ...state,
        btOnHoldRequest: (state.btOnHoldRequest, { loading: false, data: action.payload.data, err: null }),
      };
    case 'GET_BT_OH_REQUEST_INFO_FAILURE':
      return {
        ...state,
        btOnHoldRequest: (state.btOnHoldRequest, { loading: false, err: action.error, data: null }),
      };
    case 'RESET_BT_OH_REQUEST_INFO':
      return {
        ...state,
        btOnHoldRequest: (state.btOnHoldRequest, { loading: false, err: null, data: null }),
      };
    case 'GET_BT_OH_APPROVAL_INFO':
      return {
        ...state,
        btOnHoldApproval: (state.btOnHoldApproval, { loading: true, data: null, err: null }),
      };
    case 'GET_BT_OH_APPROVAL_INFO_SUCCESS':
      return {
        ...state,
        btOnHoldApproval: (state.btOnHoldApproval, { loading: false, data: action.payload.status, err: null }),
      };
    case 'GET_BT_OH_APPROVAL_INFO_FAILURE':
      return {
        ...state,
        btOnHoldApproval: (state.btOnHoldApproval, { loading: false, err: action.error, data: null }),
      };
    case 'RESET_BT_OH_APPROVAL_INFO':
      return {
        ...state,
        btOnHoldApproval: (state.btOnHoldApproval, { loading: false, err: null, data: null }),
      };
    case 'GET_SET_COMPLIANCE_REINITIATE_INFO':
      return {
        ...state,
        btReinitiateInfo: (state.btReinitiateInfo, { loading: true, data: null, err: null }),
      };
    case 'GET_SET_COMPLIANCE_REINITIATE_INFO_SUCCESS':
      return {
        ...state,
        btReinitiateInfo: (state.btReinitiateInfo, { loading: false, data: action.payload.status, err: null }),
      };
    case 'GET_SET_COMPLIANCE_REINITIATE_INFO_FAILURE':
      return {
        ...state,
        btReinitiateInfo: (state.btReinitiateInfo, { loading: false, err: action.error, data: null }),
      };
    case 'RESET_COMPLIANCE_REINITIATE_INFO':
      return {
        ...state,
        btReinitiateInfo: (state.btReinitiateInfo, { loading: false, err: null, data: null }),
      };
    default:
      return state;
  }
