...
const OnHoldRequestCancel = (props) => {
  const {
  ...
  const loading = (updatePartsOrderInfo && updatePartsOrderInfo.loading) || timeoutLoading;
  ...
  const handleStateChange = (id) => {
    try {
      if (id) {
        ...
        dispatch(updatePartsOrder(id, postData, appModels.BREAKDOWNTRACKER));
      }
    } catch (error) {
  ...
  return (
    ...
    <Dialog maxWidth="lg" minWidth="lg" open={actionModal}>
      <DialogHeader title="Cancel On-Hold Request" onClose={toggleCancel} response={updatePartsOrderInfo} />
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          ...
          >
            ...
            <Row className="justify-content-center font-family-tab">
              {updatePartsOrderInfo && updatePartsOrderInfo.data && !loading && (
                <SuccessAndErrorFormat response={updatePartsOrderInfo} successMessage="The Tracker On-Hold Request has been Cancelled." />
              )}
