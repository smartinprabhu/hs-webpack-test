...
const AdvancedSearchModal = (props) => {
  ...
  useEffect(() => {
    if (modelName && fields) {
      ...
      dispatch(getExtraSelection(company, modelName, limit, offset, fields, searchValue, otherFieldName, otherFieldValue, sortField, fieldName === 'service_category_id' ? company : false));
    }
  }, [modelName, offset, searchValue]);

  useEffect(() => {
    if (modelName) {
      dispatch(getExtraSelectionCount(company, modelName, searchValue, otherFieldName, otherFieldValue, fieldName === 'service_category_id' ? company : false));
    }
