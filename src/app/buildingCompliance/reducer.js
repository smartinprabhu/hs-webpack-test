const initialState = {
  ...
  complianceTempCount: null,
  complianceTempCountErr: null,
  complianceTempCountLoading: false,
  complianceTempInfo: {},
  complianceTempFilters: {},
  complianceTempExportInfo: {},
  templateConfig: {},
};
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'COMPLIANCE_TEMP_FILTERS':
      return {
        ...state,
        complianceTempFilters: (state.complianceTempFilters, action.payload),
      };
    ...
    case 'GET_COMPLIANCE_DOC_DETAILS':
      return {
        ...state,
        complainceDocumentsInfo: (state.complainceDocumentsInfo, { loading: true, data: null, err: null }),
      };
    case 'GET_COMPLIANCE_DOC_DETAILS_SUCCESS':
      return {
        ...state,
        complainceDocumentsInfo: (state.complainceDocumentsInfo, { loading: false, data: action.payload.data, err: null }),
      };
    case 'GET_COMPLIANCE_DOC_DETAILS_FAILURE':
      return {
        ...state,
        complainceDocumentsInfo: (state.complainceDocumentsInfo, { loading: false, err: action.error, data: null }),
      };
    case 'GET_TEMP_COMPLIANCE_COUNT_INFO':
      return {
        ...state,
        complianceTempCountLoading: true,
        complianceTempCountErr: null,
        complianceTempCount: null,
      };
    case 'GET_TEMP_COMPLIANCE_COUNT_INFO_SUCCESS':
      return {
        ...state,
        complianceTempCount: (state.complianceTempCount, action.payload),
        complianceTempCountErr: null,
        complianceTempCountLoading: false,
      };
    case 'GET_TEMP_COMPLIANCE_COUNT_INFO_FAILURE':
      return {
        ...state,
        complianceTempCountErr: (state.complianceTempCountErr, action.error),
        complianceTempCount: null,
        complianceTempCountLoading: false,
      };
    case 'GET_TEMP_COMPLIANCE_INFO':
      return {
        ...state,
        complianceTempInfo: (state.complianceTempInfo, { loading: true, data: null, err: null }),
      };
    case 'GET_TEMP_COMPLIANCE_INFO_SUCCESS':
      return {
        ...state,
        complianceTempInfo: (state.complianceTempInfo, { loading: false, data: action.payload.data, err: null }),
      };
    case 'GET_TEMP_COMPLIANCE_INFO_FAILURE':
      return {
        ...state,
        complianceTempInfo: (state.complianceTempInfo, { loading: false, data: null, err: action.error }),
      };
    case 'GET_COMPLIANCE_TEMP_EXPORT_INFO':
      return {
        ...state,
        complianceTempExportInfo: (state.complianceTempExportInfo, { loading: true, data: null, err: null }),
      };
    case 'GET_COMPLIANCE_TEMP_EXPORT_INFO_SUCCESS':
      return {
        ...state,
        complianceTempExportInfo: (state.complianceTempExportInfo, { loading: false, data: action.payload.data, err: null }),
      };
    case 'GET_COMPLIANCE_TEMP_EXPORT_INFO_FAILURE':
      return {
        ...state,
        complianceTempExportInfo: (state.complianceTempExportInfo, { loading: false, data: null, err: action.error }),
      };
    case 'GET_COMPLIANCE_CONFIG_INFO':
      return {
        ...state,
        templateConfig: (state.templateConfig, { loading: true, data: null, err: null }),
      };
    case 'GET_COMPLIANCE_CONFIG_INFO_SUCCESS':
      return {
        ...state,
        templateConfig: (state.templateConfig, { loading: false, data: action.payload.data, err: null }),
      };
    case 'GET_COMPLIANCE_CONFIG_INFO_FAILURE':
      return {
        ...state,
        templateConfig: (state.templateConfig, { loading: false, err: action.error, data: null }),
      };
    default:
      return state;
  }
