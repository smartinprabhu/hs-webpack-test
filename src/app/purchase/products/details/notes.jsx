...
const Notes = (props) => {
  ...
  const resModelId = 193;
  const [currentTab, setActive] = useState('Send Message');
        ...
        <Col sm="12" md="12" lg="12" xs="12">
          <Row className="ml-1 mr-1 mt-3">
            <Col sm="12" md="12" xs="12" lg="12">
              <Row className="m-0">
                <span className="m-1 p-1">{getDefaultNoValue(detailData.description)}</span>
              </Row>
              <hr className="mt-0" />
              ...
              {currentTab === 'Schedule Activity'
                ? (
                  <div>
                    ...
                    />
                    <br />
                    <ScheduleActivities resModalName={appModels.PARTS} resId={detailData.id} />
                  </div>
                )
                : ''}
            </Col>
