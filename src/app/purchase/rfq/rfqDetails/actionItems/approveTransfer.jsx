...
import { Button, Dialog, DialogContent, DialogContentText, Box } from '@mui/material'
...
const ApproveTransfer = (props) => {
  ...
  return (
    ...
    <Dialog maxWidth={'lg'} open={validateModal}>
      <DialogHeader title={title} onClose={toggle} response={statusUpdateInfo} />
      <DialogContent>
