...
import SalesPurchase from './salesAndPurchases';
                  ...
                  {tabs && tabs.tabsList.map((tabData) => (
                    ...
                    >
                      <Card className="border-0">
                        ...
                        >
                          { currentTab === tabData.name && currentTab === 'Sales & Purchases'
                            ? <SalesPurchase />
                            : ''}
                          { currentTab === tabData.name && currentTab === 'Misc'
                            ? <Misc />
                            : ''}
                          { currentTab === tabData.name && currentTab === 'Invoicing'
                            ? <Invoicing ids={detail.data[0].bank_ids} />
                            : ''}
                          { currentTab === tabData.name && currentTab === 'Support Ticket'
                            ? <SupportTicket />
                            : ''}
                          { currentTab === tabData.name && currentTab === 'Contact & Addresses'
                            ? <Contacts ids={detail.data[0].child_ids} />
                            : ''}
