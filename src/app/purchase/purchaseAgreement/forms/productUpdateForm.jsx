...
const ProductUpdateForm = React.memo((props) => {
  ...
  const {
    agreeProductOrders, purchaseAgreementDetails,
  ...
  useEffect(() => {
    if (agreeProductOrders && agreeProductOrders.data) {
      const newData = agreeProductOrders.data.map((cl) => ({
        ...cl,
        id: cl.id,
  ...
  const currentState = purchaseAgreementDetails && purchaseAgreementDetails.data ? purchaseAgreementDetails.data[0].state : false;
  ...
  const loading = (agreeProductOrders && agreeProductOrders.loading);
                      ...
                      <tr key={index} className="font-weight-400">
                        ...
                        <td className="p-2">
                          <Input
                            ...
                            autoComplete="off"
                            name="qty_ordered"
                            value={getFloatValue(pl.qty_ordered)}
                            onKeyPress={decimalKeyPress}
                            onChange={(e) => onQtyOrderChange(e, index)}
                          />
                        </td>
                        <td className="p-2">
                          <FormControl>
                        ...
                        <td className="p-2">
                          <DatePicker
                            ...
                            value={pl.schedule_date ? moment(new Date(getDateTimeSeconds(pl.schedule_date)), 'DD/MM/YYYY HH:mm:ss') : ''}
                            className="w-100"
