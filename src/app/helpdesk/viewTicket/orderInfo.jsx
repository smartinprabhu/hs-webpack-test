      ...
      <>
        <Row className="m-0">
          <Col sm="12" md="6" xs="12" lg="6">
            ...
            <Row className={`${detailData && detailData.id ? 'cursor-pointer text-info' : ''} m-0`} onClick={openWorkOrder}>
            ...
            <Row className="m-0">
              <span className="m-0 p-0 font-weight-700 text-capital">
                {getDefaultNoValue(getWorkOrderStateLabel(detailData.state))}
              </span>
            </Row>
            <p className="mt-2" />
            <Row className="m-0">
            ...
            <Row className="m-0">
              <span className="m-0 p-0 font-weight-700 text-capital">
                {getDefaultNoValue(extractNameObject(detailData.employee_id, 'name'))}
              </span>
            </Row>
            <p className="mt-2" />
          </Col>
