...
const Images = () => {
  ...
  const handleFiles = (files) => {
    ...
    if (files !== undefined && totalLength <= filesLimit) {
      setFilesList([...filesList, ...mergeArray(files.base64, files.fileList, companyId, appModels.HELPDESK)]);
      // setModalAlert(true);
            ...
            <span className="float-right">
              {filesList.length < filesLimit && (
                <ReactFileReader
                  ...
                  fileTypes={['.csv', '.png', '.jpg', '.jpeg', '.svg', '.doc', '.docx', '.xls', '.xlsx', '.ppt', '.pdf', '.msg']}
                  base64
                >
