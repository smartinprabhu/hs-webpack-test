...
const ProductCategoryBasicForm = React.memo((props) => {
  ...
  const {
    recipients_ids, is_recipients, is_send_email, mail_template_id, sla_state,
  } = formValues;
  ...
  // const types = !editId ? getColumnArrayById(selectedData, 'sla_state') : '';
  ...
  const types = (!editId || !editPageIndex) ? getColumnArrayById(notRemovedData, 'sla_state') : '';
        ...
        <Col xs={12} sm={6} lg={6} md={6}>
          <Col xs={12} sm={12} lg={12} md={12}>
            <MuiAutoComplete
              ...
              disableClearable
              oldvalue={getConditionLabel(sla_state)}
              value={sla_state && sla_state.label ? sla_state.label : getConditionLabel(sla_state)}
