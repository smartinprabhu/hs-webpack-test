...
const ViewTabs = (props) => {
  ...
  const { inspectionChecklistDetail } = useSelector((state) => state.inspection);
          ...
          <Col md={12} sm={12} xs={12} lg={12} className="pl-1 pr-1">
            ...
            <div className="tab-content-scroll hidden-scrollbar">
              {currentTab === 'Schedule Overview'
                ...
                : ''}
              {currentTab === 'Checklists' && inspDeata.state === 'Completed'
                ? <Checklists />
                : ''}
              {currentTab === 'Checklists' && (inspDeata.state === 'Missed' || inspDeata.state === 'Upcoming' || inspDeata.is_abnormal)
                ? <MissedChecklists />
                : ''}
            </div>
          </Col>
