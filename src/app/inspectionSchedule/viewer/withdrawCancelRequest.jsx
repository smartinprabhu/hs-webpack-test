...
const WithdrawCancelRequest = (props) => {
  const {
  ...
  const handleStateChange = async (id) => {
    if (detailData && detailData.id) {
      ...
      try {
        dispatch(updateCancelReq(id, 'hx.inspection_cancel', payload));
      } catch (error) {
...
WithdrawCancelRequest.propTypes = {
...
export default WithdrawCancelRequest;
