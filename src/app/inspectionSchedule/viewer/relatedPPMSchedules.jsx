...
const RelatedSchedules = React.memo(({
  setEvents, isTopMsg, topMsg, bottomMsg, isCustomMsg, typeSelected, selectedSchedules, events, onClose,
}) => {
        ...
        <DialogContentText id="alert-dialog-description">
          ...
          {isCustomMsg && !bottomMsg && selectedRows && selectedRows.length > 0 && (
            <p className="font-family-tab ml-2">
              ...
              {' '}
              selected for cancellation. You may deselect to retain the PPMs.
            </p>
          )}
          {isCustomMsg && bottomMsg && selectedRows && selectedRows.length > 0 && (
          <p className="font-family-tab ml-2">
          ...
          <Row className="drawer-table-scroll thin-scrollbar">
            <Col xs={12} sm={12} md={12} lg={12} className="">
              {ppmAssetsSchedules && !ppmAssetsSchedules.loading && ppmAssetsSchedules.data && partsData && partsData.length > 0 && (
