...
const PrePostPoneCancel = (props) => {
  ...
  return (
    ...
    <Dialog maxWidth="lg" minWidth="lg" open={actionModal}>
      <DialogHeader title="Cancel Prepone / Postpone Audit Request" onClose={toggleCancel} response={hxAuditUpdate} />
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          ...
          >
            ...
            <Row className="justify-content-center font-family-tab">
              {hxAuditUpdate && hxAuditUpdate.data && !loading && (
                <SuccessAndErrorFormat response={hxAuditUpdate} successMessage="The Audit Prepone and Postpone Request has been cancelled." />
              )}
        ...
        {hxAuditUpdate && hxAuditUpdate.data
          ...
          : (
            ...
            >
              ...
              Cancel Prepone / Postpone Audit Request
            </Button>
          )}
        {(hxAuditUpdate && hxAuditUpdate.data
          && (
