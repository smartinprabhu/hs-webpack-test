...
const PublishSystem = ({
  ...
  return (
    ...
    <Dialog maxWidth="lg" minWidth="lg" open={modal}>
      <DialogHeader title="Publish the System" onClose={toggleCancel} response={hxSystemUpdate} />
      <DialogContent>
          ...
          >
            ...
            <Row className="justify-content-center">
              {hxSystemUpdate && hxSystemUpdate.data && !loading && (
                <SuccessAndErrorFormat response={hxSystemUpdate} successMessage="The System has been published successfully.." />
              )}
