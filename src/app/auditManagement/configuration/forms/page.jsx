...
const Page = (props) => {
  ...
  return (
    <Dialog size="md" fullWidth open={model}>
      <DialogHeader title={!editId ? 'Create Items' : 'Update Items'} onClose={() => { toggle(); }} />
      <DialogContent>
                ...
                <Table responsive>
                  <thead className="bg-lightblue">
                    <tr>
                      ...
                      <th className="p-2 border-0 min-width-100 font-family-tab" align="right">
                    ...
                    <tr>
                      <td colSpan="3" className="text-left">
                        <div aria-hidden="true" className="font-weight-800 d-inline text-lightblue cursor-pointer mt-1 mb-1" onClick={() => { showActivityModal(true); }}>
                          ...
                          <span className="mr-2 font-family-tab">Add an Item</span>
                        </div>
                      </td>
                    </tr>
