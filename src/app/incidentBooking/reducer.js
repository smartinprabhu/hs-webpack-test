...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'UPDATE_INCIDENT_NO_INFO':
      return {
        ...state,
        updateIncidentNoInfo: (state.updateIncidentNoInfo, { loading: true, err: null, data: null }),
      };
    case 'UPDATE_INCIDENT_NO_INFO_SUCCESS':
      return {
        ...state,
        updateIncidentNoInfo: (state.updateIncidentNoInfo, { loading: false, err: null, data: action.payload.data }),
      };
    case 'UPDATE_INCIDENT_NO_INFO_FAILURE':
      return {
        ...state,
        updateIncidentNoInfo: (state.updateIncidentNoInfo, { loading: false, err: action.error, data: null }),
      };
    case 'UPDATE_INCIDENT_NO_INFO_NO_SUCCESS':
      return {
        ...state,
        updateIncidentNoInfoNo: (state.updateIncidentNoInfoNo, { loading: false, err: null, data: action.payload.data }),
      };
    case 'UPDATE_INCIDENT_NO_INFO_NO_FAILURE':
      return {
        ...state,
        updateIncidentNoInfoNo: (state.updateIncidentNoInfoNo, { loading: false, err: action.error, data: null }),
      };
    case 'RESET_INCIDENT_NO_INFO':
      return {
        ...state,
        updateIncidentNoInfo: (state.updateIncidentNoInfo, { loading: false, err: null, data: null }),
      };
