...
const DataExport = ({ afterReset}) => {
    ...
    const exportFileName = getExportFileName('Pantry_Inventory_Report')
    ...
    useEffect(() => {
        if (exportType === 'pdf') {
            handleAnswerPrint('print-pantry-inventory-report', exportFileName)
            afterReset()
        } else if (exportType === 'excel') {
            exportTableToExcel('export-inventory-pantry-reports', exportFileName);
            afterReset()
        }
    }, [exportType]);
