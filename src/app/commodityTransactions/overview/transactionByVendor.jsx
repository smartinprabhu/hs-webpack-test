...
const TransactionByVendor = () => {
  ...
  const visitorCompany = generateArrayFromValue(tankerDashboard && tankerDashboard.data ? tankerDashboard.data : [], 'code', 'TV');
...
export default TransactionByVendor;
