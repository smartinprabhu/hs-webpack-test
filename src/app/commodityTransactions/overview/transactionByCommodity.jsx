...
const TransactionByCommodity = () => {
  ...
  const visitorCompany = generateArrayFromValue(tankerDashboard && tankerDashboard.data ? tankerDashboard.data : [], 'code', 'TC');
...
export default TransactionByCommodity;
