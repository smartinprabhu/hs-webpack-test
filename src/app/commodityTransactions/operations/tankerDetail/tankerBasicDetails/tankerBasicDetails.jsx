...
const tankerBasicDetails = (props) => {
  const {
    detailData,
  } = props;
          ...
          <Row className="p-0 TicketsSegments-cards ">
            <Col sm="12" md="6" xs="12" lg="6" className="mb-2 pr-04">
              <Card className="h-100">
                <p className="ml-3 mb-1 mt-2 font-weight-600 text-pale-sky font-size-13">COMMODITY INFORMATION</p>
                <hr className="mb-0 mt-0 mr-2 ml-2" />
                <CardBody className="p-0">
                  <div className="mt-1 pl-3">
                    <CommodityInfo detailData={viewData} />
                  </div>
                </CardBody>
              </Card>
            </Col>
...
export default tankerBasicDetails;
