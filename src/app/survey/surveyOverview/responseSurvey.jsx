...
const ResponseSurvey = React.memo(({ surveyDashboard }) => {
  ...
  const surveyData = generateArrayFromValue(surveyDashboard && surveyDashboard.data ? surveyDashboard.data : [], 'code', 'TRBS');
    ...
    <Card className="p-2 border-0 h-100">
      <CardTitle className="mb-0">
        <h6>
          ...
          TOTAL RESPONSES BY COMPLETED SURVEY
        </h6>
      </CardTitle>
