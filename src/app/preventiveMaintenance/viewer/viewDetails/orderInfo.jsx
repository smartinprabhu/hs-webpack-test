    ...
    <>
      ...
      <Row className="m-0">
        <Col sm="12" md="6" xs="12" lg="6">
          ...
          <Row className={`${detailData.order_id ? 'cursor-pointer text-info' : ''} m-0`} onClick={openWorkOrder}>
            <span className="m-0 p-0 font-weight-700 text-capital">
              {getDefaultNoValue(detailData.order_name)}
            </span>
          </Row>
          <p className="mt-2" />
          <Row className="m-0">
          ...
          <Row className="m-0">
            <span className="m-0 p-0 font-weight-700 text-capital">
              {getDefaultNoValue(getWorkOrderStateLabel(detailData.order_state ? detailData.order_state.toLowerCase() : ''))}
            </span>
          </Row>
          <p className="mt-2" />
          <Row className="m-0">
