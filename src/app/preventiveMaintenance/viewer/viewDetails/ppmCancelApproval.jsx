        ...
        <DialogContentText id="alert-dialog-description">
          ...
          >
                ...
                {!isDetailView && (
                  <>
                    ...
                    <Col xs={12} sm={12} md={6} lg={6} className="col-auto">
                      ...
                      <p className="font-family-tab">{getDefaultNoValue(getCompanyTimezoneDate(pendingDetail.expires_on, userInfo, 'datetime'))}</p>
                    </Col>
                  </>
                )}
            ...
            <Row className="justify-content-center font-family-tab">
              {hxUpdatePpmCancelRequest && hxUpdatePpmCancelRequest.data && !loading && (
                <SuccessAndErrorFormat response={hxUpdatePpmCancelRequest} successMessage={type === 'cancel' ? 'The Cancellation Request for the PPM has been rejected.' : 'The PPM has been cancelled successfully..'} />
              )}
...
export default PpmCancelApproval;
