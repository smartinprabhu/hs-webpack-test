...
import pantryOrderBlue from '@images/icons/assetMiniBlue.svg';
...
const LowItems = () => {
  ...
  const loading = ((inventoryDashboard && inventoryDashboard.loading) || (isUserLoading));

  const dashboardData = getDashboardDataStructure(inventoryDashboard, 'LPI');
  let teamsIndex = 1;

  return (
    <Card className="p-2 border-0 h-100 low-items-card">
      <CardTitle>
        <h6>
