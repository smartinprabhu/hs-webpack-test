...
import { getInwardDetailSummary, resetInwardDetailSummary } from '../../inventoryService';
...
const FilterInwardDetailReport = (props) => {
  const {
    setTableHeaders,
    tableHeaders,
    selectedDate,
  ...
  useEffect(() => {
    if (userInfo && userInfo.data && userInfo.data.company && selectedDate && selectedDate !== 'Custom') {
      ...
      dispatch(getInwardDetailSummary(start, end, product, productCateg, vendor, depart));
    }
  ...
  useEffect(() => {
    if ((userInfo && userInfo.data && userInfo.data.company) && selectedDate && selectedDate === 'Custom') {
      dispatch(resetInwardDetailSummary());
      dispatch(getSelectedReportDate());
      let start = '';
      let end = '';
...
export default FilterInwardDetailReport;
