...
const SearchModalSingle = (props) => {
  ...
  useEffect(() => {
    if (modelName && fields) {
      ...
      if (fieldName !== 'category_id' && fieldName !== 'reason_id') {
        searchValueMultiple = `${searchValueMultiple}["company_id","in",[${company}]]`;
      }

      if (fieldName === 'product_id') {
        searchValueMultiple = `${searchValueMultiple},["type","=","product"]`;
        if (searchValue) {
      ...
      if (searchValue && fieldName === 'reason_id') {
        searchValueMultiple = `[["name","ilike","${searchValue}"]`;
      }

      if (fieldName === 'location_id') {
        searchValueMultiple = `${searchValueMultiple},["usage","in",["internal"]]`;
        if (searchValue) {
