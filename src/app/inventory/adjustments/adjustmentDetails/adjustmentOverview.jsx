...
const AdjustmentOverview = (props) => {
  const {
    detail,
  } = props;
        ...
        <div>
          <Row className="p-0">
            <Col sm="12" md="6" xs="12" lg="6" className="mb-2 pb-1 pr-04">
              <Card className="h-100 adjustment-overview-tabs">
