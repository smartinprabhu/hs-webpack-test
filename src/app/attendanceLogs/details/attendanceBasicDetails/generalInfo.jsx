      ...
      <>
        ...
        <Row className="m-0">
          <Col sm="12" md="12" xs="12" lg="12" className="p-0 m-0">
            <span className="m-0 p-0 font-weight-700 text-capital">
              {' '}
              {detailData.user_id && detailData.user_id[1]}
            </span>
          </Col>
        </Row>
        <p className="mt-2" />
        ...
        <Row className="m-0">
          <Col sm="12" md="12" xs="12" lg="12" className="p-0 m-0">
            <span className="m-0 p-0 font-weight-700 text-capital">
              {' '}
              {getDefaultNoValue(detailData.device_id && detailData.device_id[1])}
            </span>
          </Col>
        </Row>
        <p className="mt-2" />
        ...
        <Row className="m-0">
          <Col sm="12" md="12" xs="12" lg="12" className="p-0 m-0">
            <span className="m-0 p-0 font-weight-700">
              {' '}
              {getDefaultNoValue(detailData.vendor_id && detailData.vendor_id[1])}
            </span>
          </Col>
        </Row>
        <p className="mt-2" />
        ...
        <Row className="m-0">
          <Col sm="12" md="12" xs="12" lg="12" className="p-0 m-0">
            <span className="m-0 p-0 font-weight-700 text-capital">
              {' '}
              {getBoolean(detailData.department_id)}
            </span>
          </Col>
        </Row>
        <p className="mt-2" />
