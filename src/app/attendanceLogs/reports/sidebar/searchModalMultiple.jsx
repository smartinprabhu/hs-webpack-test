...
const SearchModalMultiple = (props) => {
  ...
  const [checkedRows, setCheckRows] = useState(fieldName === 'department_id' ? oldDepValues : oldEmpValues);
  ...
  const handleAdd = () => {
    if (checkedRows) {
      if (fieldName === 'department_id') {
        onDepChange(checkedRows);
      }
      if (fieldName === 'employee_id') {
        onEmpChange(checkedRows);
      }
    }
...
SearchModalMultiple.propTypes = {
  ...
  oldDepValues: PropTypes.array.isRequired,
  // eslint-disable-next-line react/forbid-prop-types
  oldEmpValues: PropTypes.array.isRequired,
  afterReset: PropTypes.func.isRequired,
  onDepChange: PropTypes.func.isRequired,
  onEmpChange: PropTypes.func.isRequired,
};
