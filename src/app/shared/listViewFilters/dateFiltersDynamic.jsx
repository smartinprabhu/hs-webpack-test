...
const ListDateFilters = (props) => {
  ...
  return (
    <>
      ...
      {document.getElementById(idNameFilter) && (
        <Popover placement="bottom" isOpen={filterInitailValues.filter} target={idNameFilter} className={classNameFilter || 'popoverDate'}>
          <PopoverHeader>
            Date Filters
            <img
              aria-hidden="true"
