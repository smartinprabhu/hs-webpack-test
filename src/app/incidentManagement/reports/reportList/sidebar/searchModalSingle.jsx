...
const SearchModalSingle = (props) => {
  ...
  useEffect(() => {
    if (modelName && fields) {
      ...
      if (fieldName === 'reported_by') {
        if (searchValue) {
          searchValueMultiple = `${searchValueMultiple}["name","ilike","${ChangedSearchValue}"]`;
        }
      }
      if (fieldName === 'accepted_by') {
        if (searchValue) {
          searchValueMultiple = `${searchValueMultiple}["name","ilike","${ChangedSearchValue}"]`;
        }
      }
...
SearchModalSingle.propTypes = {
  ...
  setReportedByValue: PropTypes.func.isRequired,
  setAcceptedByValue: PropTypes.func.isRequired,
};
