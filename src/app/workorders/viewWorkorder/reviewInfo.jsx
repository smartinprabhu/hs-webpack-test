        ...
        <Col sm="12" md="6" xs="12" lg="6">
          ...
          <Row className="m-0">
            <span className="m-0 p-0 font-weight-700 text-capital">
              {getDefaultNoValue(detailData.review_status ? getWorkOrderStateLabel(detailData.review_status.toLowerCase()) : '')}
            </span>
          </Row>
          <p className="mt-2" />
          <Row className="m-0">
          ...
          <Row className="m-0">
            <span className="m-0 p-0 font-weight-700 text-capital">
              {getDefaultNoValue(detailData.reviewed_by && detailData.reviewed_by.length > 0 ? extractTextObject(detailData.reviewed_by) : '')}
            </span>
          </Row>
          <p className="mt-2" />
        </Col>
